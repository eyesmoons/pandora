...
import com.pandora.common.constant.Constants.Captcha;
...
import com.pandora.common.utils.i18n.MessageUtils;
...
import com.pandora.infrastructure.thread.AsyncTaskFactory;
import com.pandora.infrastructure.thread.ThreadPoolManager;
...
import com.pandora.dao.system.enums.ConfigKeyEnum;
...
public class LoginService {
    ...
    public String login(String username, String password, String code, String uuid) {
        ...
        try {
            ...
            byte[] decryptBytes = SecureUtil.rsa(PandoraConfig.getRsaPrivateKey(), null)
    ...
    public CaptchaDTO getCaptchaImg() {
        ...
        if (isCaptchaOn) {
            ...
            // 生成验证码
            String captchaType = PandoraConfig.getCaptchaType();
