package com.pandora.infrastructure.mybatisplus;

import com.pandora.common.core.base.BaseController;
import com.pandora.common.core.base.BaseEntity;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        CodeGenerator generator = CodeGenerator.builder()
            .databaseUrl("jdbc:mysql://localhost:33067/pandora")
            .username("root")
            .password("12345")
            .author("valarchie")
            .module("/pandora-dao/target/generated-code")
            .parentPackage("com.pandora")
