package com.pandora.infrastructure.config.captcha;
...
public class CaptchaConfig {
    ...
    public DefaultKaptcha getKaptchaBeanMath() {
        ...
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL,  "com.pandora.infrastructure.config.captcha.CaptchaMathTextCreator");
        // 验证码文本字符间距 默认为2
