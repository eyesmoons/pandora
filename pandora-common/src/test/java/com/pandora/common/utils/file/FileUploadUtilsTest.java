package com.pandora.common.utils.file;
...
import com.pandora.common.exception.error.ErrorCode.Internal;
...
public class FileUploadUtilsTest {
    ...
    void getFileAbsolutePath() {
        ...
        pandoraConfig.setFileBaseDir("/tmp/pandora");

        String fileAbsolutePath = FileUploadUtils.getFileAbsolutePath(UploadSubDir.AVATAR_PATH, "test.jpg");

        Assertions.assertEquals("/tmp/pandora/profile/avatar/test.jpg", fileAbsolutePath);
    }
}
